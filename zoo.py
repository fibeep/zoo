...
class Zoo:
    ...
    def create_animal(self):
        ...
        if self.animals_left < amount:
            ...
            species = eval(
                input("What species is your animal? (Animal) (Mammal) (Platypus) (Oviparous) "))
    ...
    def expand_zoo(self, expansion):
        ...
        print(
            f"You have sucessfully expanded your zoo. The maximum amount of animals you can host is now {self.max_animals} which means you can now have {self.animals_left} more animals.")
